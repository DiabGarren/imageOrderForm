...
<head>
    ...
    <title>Delete Order | Order Form</title>
</head>
...
<body>
    ...
    <main>
        ...
        <form method="post" action="/orderForm/orders/">
            ...
            ?>
            <p class="form-warning red">Confirm Order Deletion. The delete is permanent.
            <p>
                <label for="orderFirstname">First Name</label>
                <input type="text" name="orderFirstname" id="orderFirstname" required readonly <?php
                                                                                                echo 'value="' . $order['orderFirstname'] . '"';
                                                                                                ?>>
                <label for="orderLastname">Last Name</label>
                <input type="text" name="orderLastname" id="orderLastname" required readonly <?php
                                                                                                echo 'value="' . $order['orderLastname'] . '"';
                                                                                                ?>>
                <label for="orderPhone">Phone number</label>
                <input type="text" name="orderPhone" id="orderPhone" required readonly <?php
                ...
                <textarea name="orderPrint" id="orderPrint" required readonly><?php
                                                                                echo $print;
                                                                                ?></textarea>
                <label for="orderDigital">Digital only Images</label>
                <textarea name="orderDigital" id="orderDigital" required readonly><?php
                                                                                    echo $digital;
                                                                                    ?></textarea>
